...
4. در گوشی خود منتظر دریافت پیامک حاوی کد OTP بمانید
5. بررسی کنید که پیام موفقیت در UI نمایش داده شود
...
- در Development و Production: کد OTP فقط از طریق SMS دریافت می‌شود و در پاسخ API نمایش داده نمی‌شود.
- Rate Limiting: بعد از 5 درخواست در 1 ساعت، خطای 429 دریافت کنید

### 1.2 تست تایید OTP و ورود

**روش 1: از طریق UI**
1. کد OTP دریافت‌شده را در فیلد "کد تایید" وارد کنید
...
1. **OTP واقعی**: چه در Development و چه در Production باید همیشه از کدی که از طریق SMS دریافت می‌شود استفاده شود.
