...
1. یک کالکشن پایه با نام **TamirBan CRM** ایجاد کنید و پوشه‌های زیر را در آن بسازید:
   ...
   - `Invoices`
   - `Reports`
2. برای هر محیط، متغیرهای `baseUrl`, `authToken` و `refreshToken` را تعریف کنید.
3. سناریوی ورود OTP را با استفاده از کد واقعی ارسال‌شده از سرویس پیامکی شبیه‌سازی کرده و تست‌های اعتبارسنجی پاسخ را در تب `Tests` بنویسید.
